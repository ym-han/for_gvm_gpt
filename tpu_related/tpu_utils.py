...
def get_connection(
    ...
    outputs = []
    # key_fnm = '~/.ssh/id_rsa' if from_tpu else '~/.ssh/google_compute_engine' 
    # pkey = paramiko.RSAKey( filename=os.path.expanduser(key_fnm) )
    ...
    # "pkey":  pkey
# "look_for_keys": True
#os.path.expanduser(key_fnm)

                                      # "key_filename": [os.path.expanduser('~/.ssh/id_rsa.pub'), os.path.expanduser('~/.ssh/id_rsa')]
